...
var pixel_font = preload("res://fonts/CyberpunkCraftpixPixel.otf")

func _ready():
	dialogue_label.add_theme_font_override("font", pixel_font)
	dialogue_label.add_theme_font_size_override("font_size", 8)
	...
	dialogue_label.texture_filter = CanvasItem.TEXTURE_FILTER_NEAREST
	continue_label.texture_filter = CanvasItem.TEXTURE_FILTER_NEAREST
